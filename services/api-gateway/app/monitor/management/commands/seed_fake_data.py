...
SAFE_URLS = [
    ...
    "https://www.python.org", "https://www.djangoproject.com", "https://www.cloudflare.com",
    "https://www.bing.com", "https://www.wikipedia.org", "https://www.amazon.com"
]

# Broken sites for "DOWN" status (These domains usually don't exist or block connections)
BROKEN_URLS = [
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('--monitors', type=int, default=20, help='Monitors per user')
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(f"🌱 Seeding {num_users} users with {monitors_per_user} monitors each...")
        ...
        with transaction.atomic():
            ...
            for user in users:
                for _ in range(monitors_per_user):
                    ...
                    is_broken = random.choice([True, False, False, False]) # 25% chance of broken
                    ...
                    service_name = f"{fake.word().capitalize()} {random.choice(['Service', 'Cluster', 'API', 'Worker', 'DB'])}"
        ...
        self.stdout.write(self.style.SUCCESS(
            f"✅ Done! Created {len(users)} users and {total_monitors} monitors.\n"
