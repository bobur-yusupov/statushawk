...
def test_create_monitor(user: Any) -> None:
...
@pytest.mark.django_db
def test_monitor_str(user: Any) -> None:
    monitor = Monitor.objects.create(
        user=user,
        name="Test Monitor",
        url="https://example.com",
...
@pytest.mark.django_db
def test_monitor_default_values(user: Any) -> None:
    monitor = Monitor.objects.create(
        user=user,
        name="Test",
        url="https://example.com",
...
@pytest.mark.django_db
def test_monitor_interval_validation(user: Any) -> None:
    monitor = Monitor(
        user=user,
        name="Test",
        url="https://example.com",
...
@pytest.mark.django_db
def test_monitor_cascade_delete(user: Any) -> None:
